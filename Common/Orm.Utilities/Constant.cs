...
namespace Orm.Utilities
{
	...
	public static class Constant
    {
        ...
        public const int TPS_NUMBER_ONE = 1;

        public const string AS_PHARMACY_NULL = null;
        public const string OC_PHARMACY_NULL = null;

        public const string R_STRINGWHITESPACE_NULL = " ";
        public const string BP_STRINGWHITESPACE_NULL = " ";

        public const string OR_STRINGWHITESPACE_NULL = " ";
        public const string OR_USAGE_number = "666";

        public const int OR_MZREGID_ZERO = 0;
        public const int OR_DATETIME_ONE = 1;
        public const int OR_EMPTY_TWO = 2;
        public const string OR_STRINGWHITESPACE = " ";

        public const int P_NUMBER_ZERO = 0;
        public const int P_BOOL_ONE = 1;
        public const int P_NUMBER_TWO = 2;
        public const int P_NUMBER_THREE = 3;
        public const int P_NUMBER_FOUR = 4;
        public const string P_STRINGWHITESPACE = " ";

        public const int REH_DOSAGE_ZERO = 0;
        public const int REH_LSREPTYPE_ONE = 1;
        public const string REH_STRINGWHITESPACE = " ";

        /// <summary>
        /// BusinessCommonService
        /// </summary>
        public const int BSC_CHINCHAR_LENHT = 1;
        public const int BSC_CHINCHAR_STARTINDEX = 0;
        public const string BCS_ITEMID_825865 = "825865";
        public const int BCS_AMOUNTOFMEDICALADVICE_DIGIST_TWO = 2;
        public const int BCS_AMOUNTOFMEDICALADVICE_DIGIST_SIX = 6;
        public const int BCS_ADCIVE_SKIN = 2;
        public const int BCS_FREPUENCYTIMES_0 = 0;
        public const int BCS_RATIO_0 = 0;
        public const int BCS_NUMBER_TWO = 2;
        public const int BCS_NUMBER_SIX = 6;
        public const int BCS_STATE_TRUE = 1;
        public const int BCS_STATE_FALSE = 2;
        public const int BCS_NAME_LENHT = 2;
        public const int BCS_CHINCHAR_STATRINDEX = 0;
        public const string BCS_ADVICE_ITENID = "1,2,3,7";
        public const int BCS_TEMP_STARTINDEX = 1;
        ...
        /// Login
        /// </summary>
        public const int L_INDEX_ONE = 1;
        public const int L_INDEX_TOW = 2;
        public const int L_INDEX_THREE = 3;

        /// <summary>
        /// User
        /// </summary>
        public const int U_ORDERBY_SORT = 0;
        public const int U_ICONINDEX_TYPE = 0;
        public const int U_GRADE_GENERAL = 0;
        ...
        public const int M_PHONE_MAX = 11;
        public const int M_INFOMATION_SENDING = 1;

        /// <summary>
        /// Bed
        /// </summary>
        public const int BED_TBATH_INHOSPITAL = 1;
        public const int BED_TBTO_INHOSPITAL = 4;
        public const int BED_TRUNOUT_INHOSPITAL = 5;
        public const int BED_TOBEDISCHARGED_INHOSPITAL = 9;
        ...
        /// BsPatient
        /// </summary>
        public const int BP_RVS_NOTHING = -1;
        public const int BP_NTIME_ONE = 1;

        /// <summary>
        /// CallPatirnt
        /// </summary>
        public const int CP_OTIME_MAX = 10;
        public const string CP_DOCTORCODE_1038 = "1038";
        public const string CP_DOCTORCODE_1039 = "1039";
        ...
        public const int CRM_TYPERECORD_EVALUATIONRECORD = 2;
        public const int CRM_STATEARRAYLENGTH_LEGHT = 2;

        /// <summary>
        /// InRegister
        /// </summary>
        public const int IR_STARTINDEX_ZERO = 0;
        public const int IR_TIME_HOUR = 24;
        ...
        /// OutRegister
        /// </summary>
        public const int OR_REGISTER_HOSPITALID = 0;
        public const int OR_RVS_NOTHING = 3;
        public const int OR_TIME_AGE = 0;
        public const int OR_PAYMENT_ACCOUNTAMOUNT = 0;
        public const string OR_REGISTER_DOCTORID = "0";
        public const int OR_REGISTER_VIPDISCOUNT = 100;
        public const string OR_TALLY_ZERO = "0";
        public const string OR_TALLY_ONE = "1";
        public const string OR_TALLY_TWO = "2";
        public const int OR_DIAGNOSTICCATEGORY_OTHER = 0;
        public const int OR_PATIENTINFORMMATION_VALUE = 0;


        /// <summary>
        /// Referral
        /// </summary>
        public const int R_REFERRAL_ENDOFTREATMENT = 1;
        ...
        /// QC
        /// </summary>
        public const int QC_ADDHOURS_VALUES = 24;
        public const int QC_STATUS_OPERTIME = 0;
        public const int QC_STATUS_INTIME = 1;
        ...
        /// BsItem
        /// </summary>
        public const int BI_MEDICALINSERANCE_STARTVALUE = 1;
        ...
        /// OuCharge
        /// </summary>
        public const string OC_SETTLEMENTLIST_CARDNO = "0";
        public const string OC_CANCHANGEAMOUNT_CODE = "3";
        public const int OU_VIPCARD_CARDSTATUS = 0;
        public const int OC_ARREARS_AMOUNT = 0;
        public const string OU_CHARGES_GUID = "0";
        public const int OU_CHARGE_RPTYPE = 3;
        public const int OU_DIGIST_TWO = 2;
        public const int OU_DIGIST_THREE = 3;
        public const int OU_UNITVOLUME_DIGIST = 6;
        public const int OU_AMOUNTOFMEDICALADVICE_DIGIST = 2;
        public const int OU_CHARGEDPATINETS_VIPDISCOUNT = 100;
        public const int OU_PRESCRIPTION_SKIN = 1;
        public const string OU_TEMPSTR_TRUE = "1";
        public const int OU_DRUGCOSTSFORSKIN_PICE = 0;
        public const int OU_CUSTFEE_TOTALITY = 0;
        public const int OU_CHARGE_ONCEADAY = 1;
        public const int OU_CHARGE_APPLYFORACCEPTANCEONCE = 2;
        public const int OU_CHARGE_THESECONDRECEIPT = 3;
        public const string OU_BYCHARGE_ITEMID3 = "3";
        ...
        public const string BAL_FEEID_861 = "861";
        public const string BAL_HOSPID_3 = "3";
        public const string BAL_INCITEMID_2 = "2";
        public const string BAL_ITEMID_342262 = "34226";
        public const string BAL_LOCATIONID_2313 = "2313";
        public const string BAL_OPERID_9 = "9";
		...
		/// OuExecute
		/// </summary>
		public const int OUEXECUTE_DOSAVECHANGESTOADVICEINFO_RESULTCODE = 0;
		...
		/// Common
		/// </summary>
		public const int C_VIDEOFILE_WRITE = 0;
        public const int C_VOICEFILE_WRITE = 0;
        public const int C_DOWNFILE_READ = 0;
        ...
        public const int C_Hospitalization_DAY = 1;
        public const int C_IMAGEDOCUMENT_DIGIST = 2;
        public const string C_PHYSICALEXAMIANTIONPACKAGE_TESTID = "001";
        ...
        /// RdChangeOutService
        /// </summary>
        public const int RS_WRITE_2 = 2;
        public const int RS_WRITE_3 = 3;
        public const int RS_WRITE_4 = 4;
        public const int RS_WRITE_5 = 5;
		...
		/// Infection
		/// </summary>
		public const string IF_GETRDINFECTIOUSNEWISWRITE_STRM = "0";
        public const int INFECTION_GETWRITEL1_INFECTION = 5;
        public const int INFECTION_GETWRITEL2_INFECTION = 2;

        /// <summary>
		/// Report
		/// </summary>
		public const int REP_GETDATAANALYSISINFO_TYPE = 121;
        public const int REP_INPAYSS_COUNT = 0;
        public const int REP_PATIENTINFORMATION_CHARGETYPE = 0;
        public const int REP_NEW_WEBEITE_LINK = 1;
        public const string REP_GETDATAANALYSISINFO_PARAMNAME = "cv_1";

        /// <summary>
		/// BsDocRegTypeService
		/// </summary>
		public const int BSDOCREG_PATIENTDIAGNOSIS_DIAGNUM = 0;
        public const int BSDOCREG_PATIENTDIAGNOSIS_WAITDIAGNUM = 0;

        /// <summary>
		/// BsItemService
		/// </summary>
		public const int BSLTEM_HOSPITAL_LOCATIONID = 0;

        /// <summary>
        /// GblCatalogExceptService
        /// </summary>
        public const int GES_BABY_AGE = 10;
        public const int GES_OLDER_AGE = 60;

        /// <summary>
		/// CkLabService
		/// </summary>
		public const string CKLAB_GETLISTBYCKLABANDPATID_TESTYPEID = "13";
        public const string CKLAB_GETLISTBYPATIA_TESTYPEID = "13";

        /// <summary>
        /// RdBrainDeadService
        /// </summary>
        public const string RBDS_GETLISTICDIDOREMPTYOR_CHRONICTYPE = "3";

        /// <summary>
        /// InInvoiceDtlService
        /// </summary>
        public const int IIDS_REGOPERTIME_HOUR = 24;

        /// <summary>
		/// YbPatSeqService
		/// </summary>
		public const int YP_GETLISTBYLAYBCHARGE_YBCHARGE = 1;
        public const int YP_GETLISTBYLAYBCHARGE_YBCHARGES = 2;

        /// <summary>
        /// RdInfectiousNewService
        /// </summary>
        public const int RDINFECTIOUSNEW_WRITE_INFORDINFECTIOUSNEW = 3;
        public const int RDINFECTIOUSNEW_WRITES_INFORDINFECTIOUSNEW = 4;

        /// <summary>
        /// RtrjkReportService
        /// </summary>
        public const int RTRJKREPORT_GETLISTBYHENDDATEOSPITALID_BILLCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYHENDDATEOSPITALID_INSURANCE = 0;
        public const int RTRJKREPORT_GETLISTBYENDDATEHOSPITALLD_AMOUNTCANCE = 0;
        public const int RTRJKREPORT_GETLISTBYENDDATEHOSPITALLD_INSURANCE = 0;
        public const int RTRJKREPORT_GETLISTBYDTHOSPITALLD_INSURANCE = 0;
        public const int RTRJKREPORT_GETLISTBYDTHOSPITALLD_AMOUNT = 0;
        public const int RTRJKREPORT_GETLISTBYBEGINTIMEHOSPITALLDA_AMOUNTCAANCEL = 0;
        public const int RTRJKREPORT_HOSPITALSTARTTIME_ISCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYDTHOSPITALLD_ISCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYENDDATEHOSPITALLD_ISCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYBEGINTIMEHOSPITALLDA_ISCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYHENDDATEOSPITALID_AMOUNT = 0;
        public const int RTRJKREPORT_HOSPITALSTARTTIME_AMOUNT = 0;
        public const int RTRJKREPORT_GETLISTBYHOSPITALLD_INSURANCE = 0;
        public const int RTRJKREPORT_GETLISTBYHOSPITALLD_BILLCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYENDDATEHOSPITALLD_BILLCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYDTHOSPITALLD_BILLCANCEL = 0;
        public const int RTRJKREPORT_GETLISTBYBEGINTIMEHOSPITALLDA_BILLCANCEL = 0;
        public const int RTRJKREPORT_HOSPITALSTARTTIME_BILLS = 0;
        public const int RTRJKREPORT_GETLISTBYHOSPITALLD_AMOUNTCANCEL = 0;
        ...
        /// 超级管理员的GUID
        /// </summary>
        public const string ADMIN_USERID = "663C86A0855E6986E050AA0A313010F4";
        #endregion

        /// <summary>
		/// RegCharge
		/// </summary>
		public const string REGCHARGE_QUERY_PAYWAY = "0";
        ...
        /// </summary>
        public static int[] MothArry = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };

        /// <summary>
        /// 计算机存储进制
        /// </summary>
        public const int SYSTEM_STORAGE_HEX = 1024;

        /// <summary>
        /// 默认比较温度 37°
        /// </summary>
        public const float ANIMALHEAT = 37.00F;

        /// <summary>
        /// 旧身份证长度
        /// </summary>
        public const int CERTIFICATE_LENGTH_OLD = 15;

        /// <summary>
        /// 新身份证长度
        /// </summary>
        public const int CERTIFICATE_LENGTH_NEW = 18;

        public const int INT_NUMBER_0 = 0;
        public const int INT_NUMBER_1 = 1;
        public const int INT_NUMBER_2 = 2;
        public const int INT_NUMBER_3 = 3;
        public const int INT_NUMBER_4 = 4;
        ...
        /// 住院发药缓存的业务核心表
        /// </summary>
        public const string CACHE_INSENDDRUG_KEY_TABLE = "INDRUGREQDTL";
        /// <summary>
        /// 住院信息缓存的业务核心表
        /// </summary>
        public const string CACHE_INHOSINFO_KEY_TABLE = "INHOSINFO";
        /// <summary>
        /// 长嘱缓存的业务核心表
        /// </summary>
        public const string CACHE_INADVICELONG_KEY_TABLE = "INADVICELONG";
        /// <summary>
        /// 临嘱缓存的业务核心表
        /// </summary>
        public const string CACHE_INADVICETEMP_KEY_TABLE = "INADVICETEMP";
        /// <summary>
        /// 住院退药缓存的业务核心表
        /// </summary>
        public const string CACHE_INDRUGREQBACK_KEY_TABLE = "INDRUGREQBACK";
        /// <summary>
        /// 住院中药发药缓存的业务核心表
        /// </summary>
        public const string CACHE_INCHINRICIPEDTL_KEY_TABLE = "INCHINRICIPEDTL";

        public static string[] BusinessRedisKeyTables = {
            CACHE_INSENDDRUG_KEY_TABLE,
            CACHE_INHOSINFO_KEY_TABLE,
            CACHE_INADVICELONG_KEY_TABLE,
            CACHE_INADVICETEMP_KEY_TABLE,
            CACHE_INDRUGREQBACK_KEY_TABLE,
